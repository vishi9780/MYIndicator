...
public class MyBall extends View {
    ...
    private void initView(AttributeSet attrs) {
        if (null != attrs) {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.MyBall);
            loadingColor = typedArray.getColor(R.styleable.MyBall_cradle_ball_color, Color.WHITE);
            typedArray.recycle();
        }
        paint = new Paint();
